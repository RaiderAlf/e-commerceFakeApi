            ...
            <form className="max-w-sm mx-auto my-44 [box-shadow:_0_0_5px_rgb(0_0_0_/_60%)] backdrop-blur-xl bg-white/90 rounded px-8 py-2">
                ...
                <div className="flex items-start mb-5 my-4">
                    <div className="flex items-center h-5">
                        <input id="remember" type="checkbox" checked={isChecked} onChange={handleCheckboxChange} className="w-4 h-4 border border-slate-100 rounded bg-gray-50 focus:ring-3 focus:ring-slate-300" />
                    </div>
